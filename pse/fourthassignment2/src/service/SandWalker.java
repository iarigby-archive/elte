...
public class SandWalker extends Being {
	private final static int[] waterValues = {-1, 0, 3};
	private final static int[] distanceValues = {3, 1, 0};
	private final static int maxSupply = 20;
	
	public SandWalker(String name, int supply) {
