...
public class NewNoteController implements Initializable {
    ...
    public void createNote() {
        ...
        City creator = searchForExistingCreator(creatorName);
        if (creator == null) {
            creator = new City(creatorName);
        }
    ...
    private City searchForExistingCreator(String creatorName) {
        CriteriaBuilder cb = entityManager.getCriteriaBuilder();
        CriteriaQuery<City> cq = cb.createQuery(City.class);
        Root<City> person = cq.from(City.class);
